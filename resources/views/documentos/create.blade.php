                                ...
                                <div class="pl-lg-4">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-12 col-xl-6">
                                            ...
                                            <input type="text" name="dni" class="form-control form-control-alternative @error('dni') is-invalid @enderror" value="{{ old('dni') }}">
                                            @error('dni')
                                        ...
                                        <div class="col-12 col-md-12 col-xl-6">
                                            ...
                                            <input type="text" name="nombres" class="form-control form-control-alternative" value="{{ old('nombres') }}">
                                            @error('nombres')
                                                <small class="text-danger">{{$message}}</small>
                                            @enderror 
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-12 col-xl-6" id="otros" hidden>
                                ...
                                <div class="pl-lg-4">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-12 col-xl-6">
                                            ...
                                            <input type="date" name="fecha_ingreso" class="form-control form-control-alternative"
                                                value="{{ old('fecha_ingreso') }}">
                                        </div>
                                        <div class="col-12 col-md-12 col-xl-6">
                                            <label class="form-control-label">Fecha Documento</label>
                                            <input type="date" name="fecha_doc" class="form-control form-control-alternative"
                                                value="{{ old('fecha_doc') }}">
                                        </div>
                                        <div class="col-12 col-md-12 col-xl-6">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-12 col-xl-6">
                                            ...
                                            <div class="form-group">
                                                <select name="estado" class="form-control">
                                                  ...
                                                  <option value="2">En Finalizado</option>
                                                </select>
                                              </div>
                                        </div>
                                        <div class="col-12 col-md-12 col-xl-6">
                                        ...
                                        <div class="col-12 col-md-12 col-xl-6">
                                            ...
                                            <div class="form-group">
                                                <select name="tipo_documento_id" class="form-control" id="exampleFormControlSelect1">
                                                  @foreach ($documentostipo as $documento)
                                        ...
                                        <div class="col-12 col-md-12 col-xl-6">
                                            ...
                                            <div class="form-group">
                                                <select name="oficina_id" class="form-control" id="exampleFormControlSelect1">
